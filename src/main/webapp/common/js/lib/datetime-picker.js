    ...
    .controller('DateTimePickerController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$document', '$timeout', '$uibPosition', 'dateFilter', 'uibDateParser', 'uiDatetimePickerConfig', '$rootScope',
        function ($scope, $element, $attrs, $compile, $parse, $document, $timeout, $uibPosition, dateFilter, uibDateParser, uiDatetimePickerConfig, $rootScope) {
            ...
            this.init = function (_ngModel) {
                ...
                if ($scope.datepickerOptions.buttonBar){
                    for (var button in $scope.datepickerOptions.buttonBar){
                        if (typeof $scope.datepickerOptions.buttonBar[button].show === "boolean"){
                            $scope.buttonBar[button].show = $scope.datepickerOptions.buttonBar[button].show;
                        }
                        $scope.buttonBar[button].text = $scope.datepickerOptions.buttonBar[button].text || $scope.buttonBar[button].text;
                    }
                }

                if ($scope.datepickerOptions.defaultDate){
                    $scope.defaultDate = $scope.datepickerOptions.defaultDate;
                }
...
angular.module('ui.bootstrap.datetimepicker').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('template/date-picker.html',
    ...
    "           <button type=button class=\"btn btn-sm btn-info\" ng-if=\"doShow('today')\" ng-click=\"select('today', $event)\" ng-disabled=\"isDisabled('today')\">{{ getText('today') }}</button>" +
    "           <button type=button class=\"btn btn-sm btn-primary\" ng-if=\"doShow('default')\" ng-click=\"select('default', $event)\">{{ getText('default') }}</button>" +
    "           <button type=button class=\"btn btn-sm btn-danger\" ng-if=\"doShow('clear')\" ng-click=\"select('clear', $event)\">{{ getText('clear') }}</button>" +
    "       </span>" +
    "       <span class=\"btn-group pull-right\" ng-if=\"(doShow('time') && enableTime) || doShow('close')\">" +
    "           <button type=button class=\"btn btn-sm btn-default\" ng-if=\"doShow('time') && enableTime\" ng-click=\"open('time', $event)\">{{ getText('time')}}</button>" +
    "           <button type=button class=\"btn btn-sm btn-success\" ng-if=\"doShow('close')\" ng-click=\"close(true, $event)\">{{ getText('close') }}</button>" +
    "      </span>" +
  ...
  $templateCache.put('template/time-picker.html',
    ...
    "           <button type=button class=\"btn btn-sm btn-info\" ng-if=\"doShow('now')\" ng-click=\"select('now', $event)\" ng-disabled=\"isDisabled('now')\">{{ getText('now') }}</button>" +
    "           <button type=button class=\"btn btn-sm btn-primary\" ng-if=\"doShow('default')\" ng-click=\"select('default', $event)\">{{ getText('default') }}</button>" +
    "           <button type=button class=\"btn btn-sm btn-danger\" ng-if=\"doShow('clear')\" ng-click=\"select('clear', $event)\">{{ getText('clear') }}</button>" +
    "       </span>" +
    "       <span class=\"btn-group pull-right\" ng-if=\"(doShow('date') && enableDate) || doShow('close')\">" +
    "           <button type=button class=\"btn btn-sm btn-default\" ng-if=\"doShow('date') && enableDate\" ng-click=\"open('date', $event)\">{{ getText('date')}}</button>" +
    "           <button type=button class=\"btn btn-sm btn-success\" ng-if=\"doShow('close')\" ng-click=\"close(true, $event)\">{{ getText('close') }}</button>" +
    "       </span>" +
    "       <span class=clearfix></span>" +
    "   </li>" +
