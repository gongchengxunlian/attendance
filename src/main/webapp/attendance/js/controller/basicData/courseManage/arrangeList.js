 ...
 */
//首页控制器
app.controller('courseArrangeController',['$scope', '$rootScope', '$state', '$stateParams', '$uibModal','$http','httpService','localStorageService','SweetAlert',
function($scope, $rootScope, $state, $stateParams, $uibModal, $http, httpService, localStorageService, SweetAlert) {
    ...
    function getModel(params) {
        ...
        $uibModal.open({
            ...
            keyboard: false,
            animation: true,
            templateUrl: 'arrangeForm.html',
            controller: 'courseArrangeFormController',
            resolve: {
                params: params
            },
            size: 'md'
